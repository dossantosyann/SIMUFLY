...
HOMING_SPEED_MM_S = 200.0        # Speed for HOME moves in mm/s (ensure this is also sensible, <= MAX_SPEED_MM_S if desired)
...
def _curses_main_loop(stdscr):
    ...
    while running:
        ...
        header = [
            ...
            f"Max Settable Speed: {MAX_SPEED_MM_S:.2f} mm/s", # <<< MODIFIED >>>
